...
<div className="main-content">
  <div className="ticket">
    <div className="ticket__main">
      <div className="header">Hogwarts Express</div>
      <div className="info passenger">
        <div className="info__item">Passenger</div>
        <div className="info__detail">Hermione J. Granger</div>
      </div>
      <div className="info platform"> <span>Depart </span><span>from </span><span>platform</span>
...
<aside className="context">
  <div className="explanation">Part of the <a href="https://codepen.io/collection/DQvYpQ/" target="_blank">CSS Grid collection here</a>.</div>
</aside>
